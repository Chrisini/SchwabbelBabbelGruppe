...
void create_button(gchar *name, int pos_left, int pos_top, GtkWidget *grid){
	GtkWidget *button;
...
void create_playground (GtkApplication *app, GtkWidget *box, gpointer user_data){
	...
	create_button("Demon", 4, 0, grid);

	create_button("Nexus", 4, 1, grid);

	create_button("Inhibitor", 0, 2, grid);
	create_button("Inhibitor", 4, 2, grid);
	create_button("Inhibitor", 8, 2, grid);

	create_button("Turm", 0, 3, grid);
	create_button("Turm", 4, 3, grid);
	create_button("Turm", 8, 3, grid);

	GtkWidget *separator;
	separator = gtk_separator_new (GTK_ORIENTATION_HORIZONTAL);
	gtk_grid_attach (GTK_GRID (grid), separator, 0, 4, 8, 1);

	create_button("Feld", 0, 5, grid);
	create_button("Feld", 2, 5, grid);
	create_button("Feld", 4, 5, grid);
	create_button("Feld", 6, 5, grid);
	create_button("Feld", 8, 5, grid);

	create_button("Turm", 0, 6, grid);
	create_button("Turm", 4, 6, grid);
	create_button("Turm", 8, 6, grid);

	create_button("Feld", 0, 7, grid);
	create_button("Feld", 2, 7, grid);
	create_button("Feld", 4, 7, grid);
	create_button("Feld", 6, 7, grid);
	create_button("Feld", 8, 7, grid);

	create_button("Turm", 0, 8, grid);
	create_button("Feld", 1, 8, grid);
	create_button("Feld", 3, 8, grid);
	create_button("Turm", 4, 8, grid);
	create_button("Feld", 5, 8, grid);
	create_button("Feld", 7, 8, grid);
	create_button("Turm", 8, 8, grid);

	create_button("Barron", 2, 9, grid);
	create_button("Drake", 6, 9, grid);

	create_button("Turm", 0, 10, grid);
	create_button("Feld", 1, 10, grid);
	create_button("Feld", 3, 10, grid);
	create_button("Turm", 4, 10, grid);
	create_button("Feld", 5, 10, grid);
	create_button("Feld", 7, 10, grid);
	create_button("Turm", 8, 10, grid);

	create_button("Feld", 0, 11, grid);
	create_button("Feld", 2, 11, grid);
	create_button("Feld", 4, 11, grid);
	create_button("Feld", 6, 11, grid);
	create_button("Feld", 8, 11, grid);

	create_button("Turm", 0, 12, grid);
	create_button("Turm", 4, 12, grid);
	create_button("Turm", 8, 12, grid);

	create_button("Feld", 0, 13, grid);
	create_button("Feld", 2, 13, grid);
	create_button("Feld", 4, 13, grid);
	create_button("Feld", 6, 13, grid);
	create_button("Feld", 8, 13, grid);

	separator = gtk_separator_new (GTK_ORIENTATION_HORIZONTAL);
	gtk_grid_attach (GTK_GRID (grid), separator, 0, 14, 8, 1);

	create_button("Turm", 0, 15, grid);
	create_button("Turm", 4, 15, grid);
	create_button("Turm", 8, 15, grid);

	create_button("Inhibitor", 0, 16, grid);
	create_button("Inhibitor", 4, 16, grid);
	create_button("Inhibitor", 8, 16, grid);

	create_button("Nexus", 4, 17, grid);

	create_button("Team", 0, 18, grid);
	create_button("Team", 2, 18, grid);
	create_button("Team", 4, 18, grid);
	create_button("Team", 6, 18, grid);
	create_button("Team", 8, 18, grid);
